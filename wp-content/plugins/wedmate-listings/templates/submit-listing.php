...
<div class="wml-form-wrap">
    ...
    <?php if ($errors): ?><div class="wml-form-errors" role="alert" tabindex="-1"><h2>Please check your submission</h2><ul><?php foreach ($errors->get_error_messages() as $message): ?><li><?php echo esc_html($message); ?></li><?php endforeach; ?></ul><?php if (!empty($_FILES['photos']['name'])): ?><p>Please select your photos again before resubmitting.</p><?php endif; ?></div><?php endif; ?>
