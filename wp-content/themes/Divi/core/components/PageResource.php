...
class ET_Core_PageResource {
	 ...
	 * @param bool   $skip_external_cache Whether to skip et_core_clear_wp_cache(). Default false.
	 */
	public static function remove_static_resources( $post_id, $owner = 'core', $force = false, $slug = 'all', $preserve_vb_files = false, $delete_files = false, $skip_external_cache = false ) {
		...
		self::do_remove_static_resources( $post_id, $owner, $force, $slug, $preserve_vb_files, $delete_files, $skip_external_cache );
	}
	 ...
	 * @param bool   $skip_external_cache Whether to skip et_core_clear_wp_cache(). Default false.
	 */
	public static function do_remove_static_resources( $post_id, $owner = 'core', $force = false, $slug = 'all', $preserve_vb_files = false, $delete_files = false, $skip_external_cache = false ) {
