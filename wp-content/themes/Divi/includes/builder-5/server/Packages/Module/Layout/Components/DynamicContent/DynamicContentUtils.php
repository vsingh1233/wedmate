 ...
 * - Sanitize custom-field values with oembed-aware kses.
...
class DynamicContentUtils {
	 ...
	 *
	 * Detects oembed content (iframe tags) and applies appropriate sanitization.
	 * For oembed content, it allows safe iframe attributes while still removing
	 * dangerous elements. For regular content, it uses standard wp_kses_post.
	 *
	 * @since ??
	 *
	 ...
	 */
	public static function sanitize_dynamic_content_value( string $value ): string {
