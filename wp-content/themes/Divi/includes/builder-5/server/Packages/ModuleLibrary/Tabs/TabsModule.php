...
class TabsModule implements DependencyInterface {
		...
		Style::add(
			[
				...
				'styles'        => [
							...
							'styleProps' => [
								'background' => [
									'featureSelectors' => [
										'mask'    => [
											'desktop' => [
												'value' => "{$main_selector} > .et_pb_all_tabs > .et_pb_background_mask",
											],
										],
										'pattern' => [
											'desktop' => [
												'value' => "{$main_selector} > .et_pb_all_tabs > .et_pb_background_pattern",
											],
										],
									],
								],
					...
					// Panel containing block and inactive-tab hide for Content Background layers.
					// Do not set position on `.et_pb_tab` here: the order-class selector outranks Tab Position.
					// Published FE still loads dynamic-asset tabs.css, which may not ship the hide rules.
					[
						[
							'atRules'     => false,
						...
						[
							'atRules'     => false,
							'selector'    => "{$main_selector} > .et_pb_all_tabs > .et_pb_tab",
							'declaration' => 'display: none;',
						],
						[
							'atRules'     => false,
							'selector'    => "{$main_selector} > .et_pb_all_tabs > .et_pb_tab.et_pb_active_content",
							'declaration' => 'display: block;',
						],
						[
							'atRules'     => false,
							'selector'    => "{$main_selector} > .et_pb_all_tabs > div:not(.et_pb_tab)",
							'declaration' => 'display: block;',
						],
					],
					// Active Tab.
	...
	public static function render_callback( array $attrs, string $content, WP_Block $block, ModuleElements $elements ): string {
		...
		// Render all child tab elements. Content background layers live inside the panel host.
			...
			[
				...
				'attributes'        => [
					'class' => HTMLUtility::classnames(
						...
						BackgroundClassnames::classnames( $attrs['content']['decoration']['background'] ?? [] )
					),
				],
				'childrenSanitizer' => 'et_core_esc_previously',
