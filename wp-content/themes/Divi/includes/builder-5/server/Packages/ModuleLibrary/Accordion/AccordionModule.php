			...
			[
				...
				'styles'        => [
							...
							'styleProps' => [
								'advancedStyles' => [
									[
										'componentName' => 'divi/common',
										'props'         => [
											'selector'            => $order_class . ' > .et_pb_toggle_close:not(.et_pb_toggle_empty) > .et_pb_toggle_title:before',
					...
					[
						[
							'atRules'     => false,
							'selector'    => $order_class . ' > .et_pb_toggle_empty > .et_pb_toggle_title:before',
							'declaration' => 'display: none !important; content: none !important;',
						],
					],
