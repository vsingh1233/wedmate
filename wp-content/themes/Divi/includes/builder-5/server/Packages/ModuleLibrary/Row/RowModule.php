...
class RowModule implements DependencyInterface {
	...
	public static function module_classnames( array $args ): void {
		...
		$has_explicit_gutter        = null !== $gutter_width && '' !== $gutter_width;

		if (
			! $has_explicit_gutter
			&& $is_block_layout
			&& function_exists( 'et_theme_builder_is_rendering_post_content' )
			&& et_theme_builder_is_rendering_post_content()
		) {
			$gutter_width = PageSettings::resolve_page_gutter_width( ET_Post_Stack::get_main_post_id() )['value'];
		}
