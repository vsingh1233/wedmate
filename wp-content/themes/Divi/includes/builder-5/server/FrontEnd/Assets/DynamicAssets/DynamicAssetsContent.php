...
class DynamicAssetsContent {
	 ...
	 *
	 * `$post_id` may be `0` on 404 and other post-ID-less frontend requests. In that case
	 * only Theme Builder layout-owned canvases are merged.
	 *
	 * @since ??
	 *
	 * @param string $content The post content.
	 * @param int    $post_id Post ID to get local canvases from. `0` on 404 / post-ID-less requests.
	 *
