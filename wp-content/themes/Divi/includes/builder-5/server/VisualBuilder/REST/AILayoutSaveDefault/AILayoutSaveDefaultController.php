...
class AILayoutSaveDefaultController extends RESTController {
	...
	/**
	 * Update action permission for site-wide AI layout defaults.
	 *
	 * Checks if the current user can save site-wide AI layout default fonts,
	 * colors, and description. Requires `manage_options`, matching the AJAX
	 * twin `et_ai_layout_save_defaults`.
	 *
	 * @since ??
	 *
	 ...
	 * @example:
	 * ```php
	 * $request = new WP_REST_Request( 'POST', '/divi/v1/ai_layout_save_defaults' );
	 * $result  = AILayoutSaveDefaultController::update_permission( $request );
	 * ```
	 */
