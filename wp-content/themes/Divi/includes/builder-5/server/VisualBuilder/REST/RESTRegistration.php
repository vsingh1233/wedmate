...
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentApprovalController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentChatController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentCommandsController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentFontController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentImageController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentModelsController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentPreferencesController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentPostContextController;
use ET\Builder\VisualBuilder\REST\AiAgent\AiAgentRulesController;
...
use ET\Builder\VisualBuilder\REST\DiviAIAuth\DiviAIAuthController;
...
use ET\Builder\VisualBuilder\REST\MediaLibrary\MediaLibraryController;
...
class RESTRegistration implements DependencyInterface {
	...
	public function load(): void {
		...
		/**
		 * `/ai/auth` current-user Divi AI credential lifecycle routes.
		 */
		$route
			->prefix( '/ai/auth' )
			->group(
				function ( $router ) {
					$router->get(
						...
						[
							'args'                => [],
							'callback'            => [ DiviAIAuthController::class, 'read' ],
							'permission_callback' => [ DiviAIAuthController::class, 'permission' ],
						]
					);
					$router->post(
						'',
						[
							'args'                => [ DiviAIAuthController::class, 'store_args' ],
							'callback'            => [ DiviAIAuthController::class, 'store' ],
							'permission_callback' => [ DiviAIAuthController::class, 'permission' ],
						]
					);
					$router->put(
						'',
						[
							'args'                => [ DiviAIAuthController::class, 'browser_part_args' ],
							'callback'            => [ DiviAIAuthController::class, 'renew' ],
							'permission_callback' => [ DiviAIAuthController::class, 'permission' ],
						]
					);
					$router->delete(
						...
						[
							'args'                => [],
							'callback'            => [ DiviAIAuthController::class, 'delete' ],
							'permission_callback' => [ DiviAIAuthController::class, 'permission' ],
						]
					);
				}
		...
		/**
		 * `/ai-agent` REST routes for chat image and font attachments.
		 */
		$route->post(
			'/ai-agent/upload-image',
			[
				'args'                => [ AiAgentImageController::class, 'store_args' ],
				'callback'            => [ AiAgentImageController::class, 'store' ],
				'permission_callback' => [ AiAgentImageController::class, 'store_permission' ],
			]
		);
		$route->post(
			'/ai-agent/delete-image',
			[
				'args'                => [ AiAgentImageController::class, 'destroy_file_args' ],
				'callback'            => [ AiAgentImageController::class, 'destroy_file' ],
				'permission_callback' => [ AiAgentImageController::class, 'destroy_permission' ],
			]
		);
		$route->post(
			'/ai-agent/delete-images',
			[
				'args'                => [ AiAgentImageController::class, 'destroy_chat_args' ],
				'callback'            => [ AiAgentImageController::class, 'destroy_chat' ],
				'permission_callback' => [ AiAgentImageController::class, 'destroy_permission' ],
			]
		);
		$route->post(
			'/ai-agent/import-to-media-library',
			[
				'args'                => [ AiAgentImageController::class, 'import_to_media_library_args' ],
				'callback'            => [ AiAgentImageController::class, 'import_to_media_library' ],
				'permission_callback' => [ AiAgentImageController::class, 'store_permission' ],
			]
		);
		$route->post(
			'/ai-agent/upload-font',
			[
				'args'                => [ AiAgentFontController::class, 'store_args' ],
				'callback'            => [ AiAgentFontController::class, 'store' ],
				'permission_callback' => [ AiAgentFontController::class, 'store_permission' ],
			]
		);
		$route->post(
			'/ai-agent/install-custom-fonts',
			[
				'args'                => [ AiAgentFontController::class, 'install_args' ],
				'callback'            => [ AiAgentFontController::class, 'install' ],
				'permission_callback' => [ AiAgentFontController::class, 'store_permission' ],
			]
		);
		$route->get(
			'/ai-agent/models/read',
			[
				'args'                => [ AiAgentModelsController::class, 'read_args' ],
				'callback'            => [ AiAgentModelsController::class, 'read' ],
				'permission_callback' => [ AiAgentModelsController::class, 'read_permission' ],
			]
		);
		$route->get(
			'/ai-agent/preferences/read',
			[
				'args'                => [ AiAgentPreferencesController::class, 'read_args' ],
				'callback'            => [ AiAgentPreferencesController::class, 'read' ],
				'permission_callback' => [ AiAgentPreferencesController::class, 'read_permission' ],
			]
		);
		$route->post(
			'/ai-agent/preferences/update',
			[
				'args'                => [ AiAgentPreferencesController::class, 'update_args' ],
				'callback'            => [ AiAgentPreferencesController::class, 'update' ],
				'permission_callback' => [ AiAgentPreferencesController::class, 'update_permission' ],
			]
		);
		$route->get(
			'/ai-agent/context-posts',
			[
				'args'                => [ AiAgentPostContextController::class, 'search_args' ],
				'callback'            => [ AiAgentPostContextController::class, 'search' ],
				'permission_callback' => [ AiAgentPostContextController::class, 'search_permission' ],
			]
		);
		$route->get(
			'/ai-agent/rules/read',
			[
				'args'                => [ AiAgentRulesController::class, 'read_args' ],
				'callback'            => [ AiAgentRulesController::class, 'read' ],
				'permission_callback' => [ AiAgentRulesController::class, 'read_permission' ],
			]
		);
		$route->post(
			'/ai-agent/approvals/mint',
			[
				'args'                => [ AiAgentApprovalController::class, 'mint_args' ],
				'callback'            => [ AiAgentApprovalController::class, 'mint' ],
				'permission_callback' => [ AiAgentApprovalController::class, 'permission' ],
			]
		);
		$route->post(
			'/ai-agent/rules/create',
			[
				'args'                => [ AiAgentRulesController::class, 'create_args' ],
				'callback'            => [ AiAgentRulesController::class, 'create' ],
				'permission_callback' => [ AiAgentRulesController::class, 'create_permission' ],
			]
		);
		$route->post(
			'/ai-agent/rules/update',
			[
				'args'                => [ AiAgentRulesController::class, 'update_args' ],
				'callback'            => [ AiAgentRulesController::class, 'update' ],
				'permission_callback' => [ AiAgentRulesController::class, 'update_permission' ],
			]
		);
		$route->post(
			'/ai-agent/rules/delete',
			[
				'args'                => [ AiAgentRulesController::class, 'delete_args' ],
				'callback'            => [ AiAgentRulesController::class, 'delete' ],
				'permission_callback' => [ AiAgentRulesController::class, 'delete_permission' ],
			]
		);
		$route->post(
			'/ai-agent/rules/duplicate',
			[
				'args'                => [ AiAgentRulesController::class, 'duplicate_args' ],
				'callback'            => [ AiAgentRulesController::class, 'duplicate' ],
				'permission_callback' => [ AiAgentRulesController::class, 'duplicate_permission' ],
			]
		);
		$route->get(
			'/ai-agent/commands/read',
			[
				'args'                => [ AiAgentCommandsController::class, 'read_args' ],
				'callback'            => [ AiAgentCommandsController::class, 'read' ],
				'permission_callback' => [ AiAgentCommandsController::class, 'read_permission' ],
			]
		);
		$route->post(
			'/ai-agent/commands/create',
			[
				'args'                => [ AiAgentCommandsController::class, 'create_args' ],
				'callback'            => [ AiAgentCommandsController::class, 'create' ],
				'permission_callback' => [ AiAgentCommandsController::class, 'create_permission' ],
			]
		);
		$route->post(
			'/ai-agent/commands/update',
			[
				'args'                => [ AiAgentCommandsController::class, 'update_args' ],
				'callback'            => [ AiAgentCommandsController::class, 'update' ],
				'permission_callback' => [ AiAgentCommandsController::class, 'update_permission' ],
			]
		);
		$route->post(
			'/ai-agent/commands/delete',
			[
				'args'                => [ AiAgentCommandsController::class, 'delete_args' ],
				'callback'            => [ AiAgentCommandsController::class, 'delete' ],
				'permission_callback' => [ AiAgentCommandsController::class, 'delete_permission' ],
			]
		);
		$route->post(
			'/ai-agent/commands/duplicate',
			[
				'args'                => [ AiAgentCommandsController::class, 'duplicate_args' ],
				'callback'            => [ AiAgentCommandsController::class, 'duplicate' ],
				'permission_callback' => [ AiAgentCommandsController::class, 'duplicate_permission' ],
			]
		);
		...
		$route->post(
			...
			[
				...
				'permission_callback' => [ OutsideVbController::class, 'create_template_permission' ],
			]
		);
		...
		$route->post(
			...
			[
				...
				'permission_callback' => [ OutsideVbController::class, 'update_theme_option_permission' ],
			]
		);
		...
		$route->post(
			'/outside-vb/read-web-page',
			[
				'args'                => [ OutsideVbController::class, 'read_web_page_args' ],
				'callback'            => [ OutsideVbController::class, 'read_web_page' ],
				'permission_callback' => [ OutsideVbController::class, 'read_web_page_permission' ],
			]
		);
		...
		$route->get(
			...
			[
				'args'                => [ MediaLibraryController::class, 'search_args' ],
				'callback'            => [ MediaLibraryController::class, 'search' ],
				'permission_callback' => [ MediaLibraryController::class, 'search_permission' ],
			]
		);

		$route->post(
			'/media-library/sideload-from-url',
			[
				'args'                => [ MediaLibraryController::class, 'sideload_from_url_args' ],
				'callback'            => [ MediaLibraryController::class, 'sideload_from_url' ],
				'permission_callback' => [ MediaLibraryController::class, 'sideload_from_url_permission' ],
			]
		);
		...
		$route->post(
			...
			[
				...
				'permission_callback' => [ MenuManagerController::class, 'create_permission' ],
			]
		);
		...
		$route->post(
			...
			[
				...
				'permission_callback' => [ MenuManagerController::class, 'delete_permission' ],
			]
		);
		...
		$route->post(
			...
			[
				...
				'permission_callback' => [ MenuManagerController::class, 'assign_location_permission' ],
			]
		);
		...
		$route->post(
			'/menu-manager/items/batch-create',
			[
				'args'                => [ MenuItemsController::class, 'batch_create_args' ],
				'callback'            => [ MenuItemsController::class, 'batch_create' ],
				'permission_callback' => [ MenuItemsController::class, 'menu_item_permission' ],
			]
		);

		$route->post(
			'/menu-manager/items/batch-delete',
			[
				'args'                => [ MenuItemsController::class, 'batch_delete_args' ],
				'callback'            => [ MenuItemsController::class, 'batch_delete' ],
				'permission_callback' => [ MenuItemsController::class, 'batch_delete_permission' ],
			]
		);
		...
		$route->post(
			'/menu-manager/items/list',
			[
				'args'                => [ MenuItemsController::class, 'list_args' ],
				'callback'            => [ MenuItemsController::class, 'list_items' ],
				'permission_callback' => [ MenuItemsController::class, 'list_permission' ],
			]
		);
		...
		$route->get(
			...
			[
				'args'                => [ AiAgentChatController::class, 'list_threads_args' ],
				'callback'            => [ AiAgentChatController::class, 'list_threads' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->get(
			'/ai-agent-chat/threads/show',
			[
				'args'                => [ AiAgentChatController::class, 'show_thread_args' ],
				'callback'            => [ AiAgentChatController::class, 'show_thread' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/create',
			[
				'args'                => [ AiAgentChatController::class, 'create_thread_args' ],
				'callback'            => [ AiAgentChatController::class, 'create_thread' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/reorder',
			[
				'args'                => [ AiAgentChatController::class, 'reorder_threads_args' ],
				'callback'            => [ AiAgentChatController::class, 'reorder_threads' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/update',
			[
				'args'                => [ AiAgentChatController::class, 'update_thread_args' ],
				'callback'            => [ AiAgentChatController::class, 'update_thread' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/context',
			[
				'args'                => [ AiAgentChatController::class, 'save_context_args' ],
				'callback'            => [ AiAgentChatController::class, 'save_context' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/delete',
			[
				'args'                => [ AiAgentChatController::class, 'delete_thread_args' ],
				'callback'            => [ AiAgentChatController::class, 'delete_thread' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/messages/upsert',
			[
				'args'                => [ AiAgentChatController::class, 'upsert_message_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_message' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/checkpoints/upsert',
			[
				'args'                => [ AiAgentChatController::class, 'upsert_checkpoint_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_checkpoint' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/checkpoints/delete',
			[
				'args'                => [ AiAgentChatController::class, 'delete_thread_checkpoints_args' ],
				'callback'            => [ AiAgentChatController::class, 'delete_thread_checkpoints' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/pending-writes/upsert',
			[
				'args'                => [ AiAgentChatController::class, 'upsert_pending_write_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_pending_write' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/restore-points/upsert',
			[
				'args'                => [ AiAgentChatController::class, 'upsert_restore_point_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_restore_point' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->get(
			'/ai-agent-chat/restore-points/show',
			[
				'args'                => [ AiAgentChatController::class, 'show_restore_point_args' ],
				'callback'            => [ AiAgentChatController::class, 'show_restore_point' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/threads/restore',
			[
				'args'                => [ AiAgentChatController::class, 'restore_thread_args' ],
				'callback'            => [ AiAgentChatController::class, 'restore_thread' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/checkpoints/upsert/batch',
			[
				'args'                => [ AiAgentChatController::class, 'batch_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_checkpoint_batch' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);

		$route->post(
			'/ai-agent-chat/pending-writes/upsert/batch',
			[
				'args'                => [ AiAgentChatController::class, 'batch_args' ],
				'callback'            => [ AiAgentChatController::class, 'upsert_pending_write_batch' ],
				'permission_callback' => [ AiAgentChatController::class, 'permission' ],
			]
		);
	}
