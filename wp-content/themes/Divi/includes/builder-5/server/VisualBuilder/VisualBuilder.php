...
use ET\Builder\Framework\Database\DiviAIChatSchema;
...
// Bootstrap AI chat history schema (registers $wpdb aliases + runs dbDelta if needed).
DiviAIChatSchema::init();
...
$dependency_tree->add_dependency( new AiAgentCommands() );
$dependency_tree->add_dependency( new AiAgentRules() );
