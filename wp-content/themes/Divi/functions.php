...
function et_divi_add_customizer_css() {
		...
		$scope_heading_selectors = function ( $selectors ) use ( $is_vb ) {
			...
			// TB layout wrappers cover portal-fallback inline render when app roots are absent (#52094).
		...
		$forced_inline     = $is_preview || ET_Core_PageResource::should_force_inline_for_paginated_request() || ! et_core_is_static_css_enabled() || post_password_required();
